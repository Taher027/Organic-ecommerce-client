...
const Header = () => {
	const menuItems = (
		<>
			...
			<li className="hover:bg-[#274C5B] ">
				<a className="hover:text-white">News</a>
			</li>
			<li className="hover:bg-[#274C5B] ">
				...
				<div className="navbar-start">
					...
					<div className="flex gap-1 justify-center items-center">
						<img
							...
							alt="logo"
						/>
						<a className="text-2xl md:text-4xl font-bold  text-[#274C5B] ">
							Organic
						</a>
					</div>
				</div>
					...
					<div className="w-full md:w-auto py-2   cursor-pointer">
						<div className="flex flex-row items-center justify-between">
							...
							<div className="text-sm pl-6 pr-2 text-gray-600 flex flex-row items-center gap-3 ">
								...
								<Link
									className="font-bold text-[#274C5B] md:text-xl md:px-5 md:py-2 text-xl rounded-lg border-[1px] px-2 py-1 "
									to="/"
								>
									SignUp
								</Link>
